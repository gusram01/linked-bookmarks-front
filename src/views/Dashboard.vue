<template>
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
      <div>
        ...
        <p class="text-gray-600">
          {{ hasBookmarks ? `${bookmarkCount} saved ${bookmarkCount === 1 ? 'link' : 'links'}` : 'Manage your saved links' }}
        </p>
      </div>
    ...
    <!-- Bookmarks Grid -->
    <div v-else-if="hasBookmarks" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div
        v-for="bookmark in bookmarks"
        :key="bookmark.id"
        class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-200 group"
      >
        ...
        <div class="flex items-center justify-between">
          ...
          >
            ...
            <span class="truncate">{{ getHostname(bookmark.url) }}</span>
          </a>
...
const { bookmarks, loading, error, successMessage, hasBookmarks, bookmarkCount } = storeToRefs(bookmarkStore)
